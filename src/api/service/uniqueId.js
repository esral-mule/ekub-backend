...
exports.AddMember = async (uniqueIdId, memeberId, isFull = false) => {
  try {
    ...
    const newMembers = previousUniqueId.members
      ? previousUniqueId.members.concat([idObjectId])
      : [idObjectId];
...
exports.GetAll = async (req) => {
  try {
    const { limit, page, uniqueId, isFull, isWinner, sort } = req.query;
    ...
    if (typeof Boolean(isFull) === typeof true)
...
exports.GetAvailable = async (equbType) => {
  try {
    ...
    const roundsInCycle = await RoundModel.find({
